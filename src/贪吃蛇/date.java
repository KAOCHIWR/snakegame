...
//放数据和图片
public class date {
    public static ImageIcon right = new ImageIcon("photo/right.png");
    public static ImageIcon body = new ImageIcon("photo/body.png");
    public static ImageIcon down = new ImageIcon("photo/down.png");
